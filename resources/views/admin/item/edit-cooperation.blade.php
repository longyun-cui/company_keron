...
@section('title')
    @if($operate == 'create') 添加合作伙伴 @else 编辑合作伙伴 @endif
@endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/item/list?category=cooperation')}}"><i class="fa "></i> 合作伙伴列表</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加合作伙伴 @else 编辑合作伙伴 @endif</h3>

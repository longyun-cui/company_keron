...
@section('title')
    @if($operate == 'create') 添加客户案例 @else 编辑客户案例 @endif
@endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/item/list?category=cooperation')}}"><i class="fa "></i> 客户案例列表</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加客户案例 @else 编辑客户案例 @endif</h3>
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/item/list?category=customer')}}";
                    }
                }
            };

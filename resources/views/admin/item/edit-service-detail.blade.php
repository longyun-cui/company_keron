...
@section('title')
    @if($operate == 'create') 添加详情 @else 编辑详情 @endif
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加详情 @else 编辑详情 @endif</h3>
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="category" value="67" readonly>

                {{--目录--}}
                <div class="form-group">
                    <label class="control-label col-md-2">选择服务</label>
                    <div class="col-md-8 ">
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/item/list?category=service_detail')}}";
                    }
                }
            };

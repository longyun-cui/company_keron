...
@section('title')
    @if($operate == 'create') 添加优惠活动 @else 编辑优惠活动 @endif
@endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/item/list?category=activity')}}"><i class="fa "></i> 内容列表</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加优惠活动 @else 编辑优惠活动 @endif</h3>
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="category" value="29" readonly>

   ...
   <body>
				   ...
				   <div class="header-bar py-sm-2">
					   <div class="container py-2">
						   <nav class="navbar navbar-expand-lg navbar-light">
							   <div class="hedder-up">
								   <h1><a class="navbar-brand" href="index.html">Peregrinate</a></h1>
							   </div>
	   ...
	   <section class="wthree-row w3-about py-md-5">
		   <div class="container py-4 mt-2">
			   <h3 class="tittle text-center mb-3">Different Way Of Traveling</h3>
			   ...
			   <div class="card-deck pt-4 mt-md-4">
				   <div class="card">
					   <img src="images/g13.jpg" class="img-fluid"  alt="Card image cap">
				   ...
				   <div class="card">
					   <img src="images/g14.jpg" class="img-fluid"  alt="Card image cap">
					   <div class="card-body w3ls-card">
				   ...
				   <div class="card">
					   <img src="images/g12.jpg" class="img-fluid"  alt="Card image cap">
					   <div class="card-body w3ls-card">
	   ...
	   <section class="features py-md-5">
		   <div class="container py-4 mt-2">
			   <h3 class="tittle text-center mb-3">What Say Customers</h3>
			   <p class="tit text-center mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius eum inventore consectetur dolorum, voluptatum possimus temporibus vel ab, nesciunt quod!</p>

			   <div class="row about-main pt-4 mt-md-4">
				   <div class="col-lg-5 about-right">
					   <h4>Join to Happy Customers</h4>
								   ...
								   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
									   ...
									   <div class="carousel-inner">
										   ...
										   <div class="carousel-item">
											   ...
											   <div class="row thumbnail adjust1 fone">
												   <div class="col-md-3 col-sm-3">
													   <img class="media-object img-fluid" src="images/ts4.jpg" alt="" />
												   </div>
												   <div class="col-md-9 col-sm-9">
													   <div class="caption testi-text">
														   <p>
	   ...
	   <section class="wthree-row w3-about py-md-5">
		   <div class="container py-4 mt-2">
			   <h3 class="tittle text-center mb-3">News & Update</h3>
			   <p class="tit text-center mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius eum inventore consectetur dolorum, voluptatum possimus temporibus vel ab, nesciunt quod!</p>
			   <div class="card-deck pt-4 mt-md-4">
				   <div class="card">
					   <img src="images/g11.jpg" class="img-fluid"  alt="Card image cap">
					   <div class="card-body w3ls-card">
				   ...
				   <div class="card">
					   <img src="images/g10.jpg" class="img-fluid"  alt="Card image cap">
					   <div class="card-body w3ls-card">
						   <h4 class="card-title">Free service seems to good to be true</h4>
						   <p class="card-text mb-3 ">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
						   <a href="#" data-toggle="modal" data-target="#myModal">Read More</a>
				   ...
				   <div class="card">
					   <img src="images/g9.jpg" class="img-fluid"  alt="Card image cap">
					   <div class="card-body w3ls-card">
						   <h4 class="card-title">Free service seems to good to be true</h4>
						   <p class="card-text mb-3 ">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
						   <a href="#" data-toggle="modal" data-target="#myModal">Read More</a>
